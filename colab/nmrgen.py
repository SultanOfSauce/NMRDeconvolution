...
def generateRandomSpectrum(seed = None, peakMode = "narrow", numberOut = "onehot") -> npt.ArrayLike:
    ...
    return {"pure": yy, "true": yy + noise, "filtered": yyFiltered, "reg": yyReg}, (peaks, peaksWidth)
